        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={group} onValueChange={setGroup}>
              ...
              <SelectContent>
                <SelectItem value="Pregnancy Support">Pregnancy Support</SelectItem>
                ...
                <SelectItem value="University Safety">University Safety</SelectItem>
          ...
          {imageUrl ? (
            <div className="space-y-2">
              <div className="relative rounded-md overflow-hidden">
                <img src={imageUrl} alt="Post" className="w-full h-auto max-h-48 object-cover" />
                <Button
                  type="button"
                  variant="destructive"
                  size="sm"
